...
הצמח צומח ככל שהמשתמש מביע יותר רגשות ומקיים יותר אינטראקציה בתוך האפליקציה. כשהצמח גדל, הוא מייצר **פירות** — בפועל **אייקונים ייחודיים**. לכל אייקון יש ייצוג יחיד באפליקציה מול כל המשתמשים. את הפירות אפשר להעביר לאחרים בתגובה לאינטראקציות שלהם (כפי שיופיע במסכים בהמשך).
